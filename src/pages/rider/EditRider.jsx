...
import { getById, update } from "../../services/Riderservice";
...
function EditRider() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setResultSecond(response.data.data.profilePicture);
      setResult(response.data.data.riderInfos[0].driverLicense);
      setResultThird(response.data.data.riderInfos[0].vehicleLicense);
      const resetObj = {
        Fullname: "",
        Email: "",
        Password: "",
      ...
      resetObj.Fullname = response.data.data.fullname;
      resetObj.Email = response.data.data.email;
      resetObj.PhoneNumber = response.data.data.phoneNumber;
      //password is Hardcoded
      // resetObj.Password = "@Dmin123";
      resetObj.Name = response.data.data.vehicleInfos[0].name;
      resetObj.Model = response.data.data.vehicleInfos[0].model;
      resetObj.Number = response.data.data.vehicleInfos[0].number;
      resetObj.Insurance = response.data.data.riderInfos[0].insurance;
      reset(resetObj);
      setLoader(true);
    })();
  }, []); //eslint-disable-line
  ...
  const submitForm = async (formData) => {
    ...
    body.RiderInfos[0].DriverLicense = resultSecond;
    body.RiderInfos[0].VehicleLicense = resultThird;
    ...
    if (uploadImageThird !== null) {
      ...
      formData3.append("vehicleImage", uploadImageSecond);
