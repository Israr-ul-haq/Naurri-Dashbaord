...
function EditRestaurant() {
  ...
  const { resultSecond, uploaderSecond, setResultSecond } =
    useDisplayImageSecond();
  ...
  useEffect(() => {
    (async () => {
      ...
      setResultSecond(response.data.data.user.profilePicture);
      ...
      resetObj.Fullname = response.data.data.user.fullname;
      resetObj.Email = response.data.data.user.email;
      resetObj.PhoneNumber = response.data.data.user.phoneNumber;
      resetObj.NationalId = "055868989898";
      resetObj.DateOfBirth = "05/05/2020";
      resetObj.Password = response.data.data.password;
      resetObj.RestaurantName = response.data.data.name;
      resetObj.RestaurantEmail = response.data.data.email;
      resetObj.RestaurantPhoneNumber = response.data.data.phoneNumber;
      resetObj.RestaurantAddress = response.data.data.address;
      resetObj.BankName = response.data.data.restaurantBankInfos[0].bankName;
      resetObj.BankAccount =
        response.data.data.restaurantBankInfos[0].bankAccount;
  ...
  const submitForm = async (formData) => {
    ...
    body.Restaurants[0].Image = resultSecond;
